...
public class ALUMNI_OF_CIVIL_ENGINEERING extends JFrame implements ActionListener  {
    ...
    public ALUMNI_OF_CIVIL_ENGINEERING () {
        setVisible(true);
        setSize(700, 700);
        setLayout(null);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setTitle("AMITY ALUMNI ASSOCIATION OF CIVIL ENGINEERING");
    ...
    public void showData() {
        ...
        f1.setTitle("AMITY ALUMNI ASSOCIATION OF CIVIL ENGINEERING");
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from civil where NAME=?");
    ...
    public static void main() {
        ...
        new ALUMNI_OF_CIVIL_ENGINEERING();
