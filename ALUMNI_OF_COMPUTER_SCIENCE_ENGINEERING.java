...
public class  ALUMNI_OF_COMPUTER_SCIENCE_ENGINEERING extends JFrame implements ActionListener  {
    ...
    public  ALUMNI_OF_COMPUTER_SCIENCE_ENGINEERING () {
        setVisible(true);
        setSize(700, 700);
        setLayout(null);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setTitle("AMITY ALUMNI ASSOCIATION OF COMPUTER SCIENCE & ENGINEERING");
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select NAME from cse");
    ...
    public void showData() {
        ...
        f1.setTitle("AMITY ALUMNI ASSOCIATION OF COMPUTER SCIENCE &  ENGINEERING");
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from cse where NAME=?");
    ...
    public static void main() {
        ...
        new  ALUMNI_OF_COMPUTER_SCIENCE_ENGINEERING();
