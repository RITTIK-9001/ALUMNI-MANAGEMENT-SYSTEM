...
public class  ALUMNI_OF_ELECTRONICS_COMMUNICATION_ENGINEERING extends JFrame implements ActionListener  {
    ...
    public   ALUMNI_OF_ELECTRONICS_COMMUNICATION_ENGINEERING() {
        setVisible(true);
        setSize(700, 700);
        setLayout(null);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setTitle("AMITY ALUMNI ASSOCIATION OF ELECTRONICS & COMMUNICATION ENGINEERING");
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select NAME from ece");
    ...
    public void showData() {
        ...
        f1.setTitle("AMITY ALUMNI ASSOCIATION OF ELECTRONICS & COMMUNICATION ENGINEERING");
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from ece where NAME=?");
    ...
    public static void main() {
        ...
        new   ALUMNI_OF_ELECTRONICS_COMMUNICATION_ENGINEERING();
