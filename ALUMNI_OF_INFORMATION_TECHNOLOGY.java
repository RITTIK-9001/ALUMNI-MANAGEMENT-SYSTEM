...
public class   ALUMNI_OF_INFORMATION_TECHNOLOGY extends JFrame implements ActionListener  {
    ...
    public    ALUMNI_OF_INFORMATION_TECHNOLOGY() {
        setVisible(true);
        setSize(700, 700);
        setLayout(null);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setTitle("AMITY ALUMNI ASSOCIATION OF INFORMATION TECHNOLOGY");
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select NAME from it");
    ...
    public void showData() {
        ...
        f1.setTitle("AMITY ALUMNI ASSOCIATION OF INFORMATION TECHNOLOGY");
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from it where NAME=?");
    ...
    public static void main() {
        ...
        new   ALUMNI_OF_INFORMATION_TECHNOLOGY();
